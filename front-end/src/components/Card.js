  ...
  return (
    <div className="mt-28 mb-28">
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="p-4 sm:p-6 lg:p-8 border border-gray-200 rounded-lg shadow shadow-gray-200 min-h-[250px] flex flex-col">
          <div className="bg-[#d5f5e5] p-2 rounded-lg w-fit mb-4 shrink-0">
            <CheckCircle2 className="text-[#31cf83] w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-4">
        ...
        <div className="p-4 sm:p-6 lg:p-8 border border-gray-200 rounded-lg shadow shadow-gray-200 min-h-[250px] flex flex-col">
          <div className="bg-[#f1f2fc] p-2 rounded-lg w-fit mb-4 shrink-0">
            <CircleDollarSign className="text-[#d5d8f0] w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-4">
        ...
        <div className="p-4 sm:p-6 lg:p-8 border border-gray-200 rounded-lg shadow shadow-gray-200 min-h-[250px] flex flex-col">
          <div className="bg-[#c2e9f1] p-2 rounded-lg w-fit mb-4 shrink-0">
            <Clock className="text-[#59c5d9] w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-4">
        ...
        <div className="p-4 sm:p-6 lg:p-8 border border-gray-200 rounded-lg shadow shadow-gray-200 min-h-[250px] flex flex-col">
          <div className="bg-[#f9dcc0] p-2 rounded-lg w-fit mb-4 shrink-0">
            <MessageCircleQuestion className="text-[#ec9136] w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <h2 className="text-base sm:text-lg lg:text-xl font-semibold mb-2 sm:mb-4">
